...
public class AgeScrollView extends View {
    ...
    public AgeScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void setData(List<Age> datas) {
        mDataList = datas;
    ...
    private void moveHeadToTail() {
        Age head = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(head);
    }

    private void moveTailToHead() {
        Age tail = mDataList.get(mDataList.size() - 1);
    ...
    private void drawData(Canvas canvas) {
        ...
        String textData = mDataList.get(indexs).getAge();
